...
export class AppMenu {
    model: MenuItem[] = [];
    model2!: ({ label: string; items: ({ label: string; icon: string; routerLink: string[]; class?: undefined; } | { label: string; icon: string; class: string; routerLink: string[]; })[]; icon?: undefined; routerLink?: undefined; } | { label: string; icon: string; routerLink: string[]; items: ({ label: string; icon: string; routerLink: string[]; items?: undefined; } | { label: string; icon: string; items: { label: string; icon: string; routerLink: string[]; }[]; routerLink?: undefined; })[]; } | { label: string; items: { label: string; icon: string; items: { label: string; icon: string; items: { label: string; icon: string; }[]; }[]; }[]; icon?: undefined; routerLink?: undefined; } | { label: string; items: ({ label: string; icon: string; routerLink: string[]; url?: undefined; target?: undefined; } | { label: string; icon: string; url: string; target: string; routerLink?: undefined; })[]; icon?: undefined; routerLink?: undefined; })[];
